...
const FormSchema = z.object({
  ...
  private_po_box: z.string().optional(),
  private_marital_status: z.string().optional(),
  private_spouses_name: z.string().optional(),
  private_number_of_children: z.number().optional(),
  private_employer_name: z.string().optional(),
  private_bank_statement_rib: z.string().optional(),
