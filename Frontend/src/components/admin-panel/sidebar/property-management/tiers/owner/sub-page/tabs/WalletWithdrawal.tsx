...
const WalletWithdrawalComponent = () => {
  ...
  return (
    <div className='space-y-5'>
      ...
      <DynamicTable title="List of WalletWithdrawalComponent" columns={columns} data={data} pageSize={5} addButton={false} />
    </div>
    </div>
  );
};

export default WalletWithdrawalComponent;
