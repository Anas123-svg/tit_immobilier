...
const SocialTaxChargesAccounts = () => {
  const data:any = []
  ...
  return (
    ...
    <DynamicTable title='Corporate/tax expense accounts.' addButton={false} columns={columns} data={data} pageSize={5} />
...
export default SocialTaxChargesAccounts;
