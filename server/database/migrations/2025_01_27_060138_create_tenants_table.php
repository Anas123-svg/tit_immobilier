...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tenants', function (Blueprint $table) {
            ...
            $table->string('private_signatory_authority')->nullable();
            $table->string('private_expiry_date')->nullable();
            $table->string('private_taxpayer_account_number')->nullable();
            ...
            $table->string('private_mail_box')->nullable();
            ...
            $table->string('business_taxpayer_account_number')->nullable();
            ...
            $table->string('business_mail_box')->nullable();
            ...
            $table->boolean('is_business_tenant')->default(false);
            $table->timestamps();        });
    }
